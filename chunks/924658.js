e.exports = Object.freeze({
  ...
  MESSAGE_REMINDERS_MARK_COMPLETE: 'Mark Complete',
  ...
  CLAN_SETUP_SIGN_SUBTITLE: 'One last step - sign the charter to become a Guild. Your Guild won\'t be discoverable for a few days while the Guilds page gets ready. When it launches, only a select number of people will be able to see it and apply.',
  CLAN_SETUP_OPTIONAL: 'Optional',
  CLAN_SETUP_WILDCARDS_SUBTITLE: 'Choose up to 3 words that describe your Guild. Be creative!!',
  ...
  CLAN_PRIMETIME_MORNING: 'Morning',
  CLAN_PRIMETIME_AFTERNOON: 'Afternoon',
  CLAN_PRIMETIME_EVENING: 'Evening',
  CLAN_PRIMETIME_LATE_NIGHT: 'Late Night',
  CLAN_PRIMETIME_FORMATTED_RECURRING_TIME: '{day} {time}',
  CLAN_PRIMETIME_RECURRING_WEEKDAY: 'Weekday',
  CLAN_PRIMETIME_RECURRING_WEEKEND: 'Weekend',
  CLAN_PRIMETIME_RECURRING_MORNING: 'mornings',
  ...
  CLAN_TAG_TOOLTIP_TEXT: 'Member of {guildName}',
  ...
  USER_SETTINGS_EDIT_PRIMARY_GUILD_TAG_LABEL: 'Edit Primary Guild',
  ...
  CLAN_DISCOVERY_OTHER_GUILDS_TITLE: 'Other Guilds',
  ...
  CLAN_DISCOVERY_SAVED_GUILDS: 'Saved',
  ...
  ICYMI_ITEM_HEADER_SUBTITLE_INTERESTING: ' sent a message you might find interesting:',
  ICYMI_ITEM_HEADER_SUBTITLE_ANNOUNCEMENT: ' posted an announcement:',
  ICYMI_ITEM_HEADER_SUBTITLE_FILE: ' uploaded a file:',
  ICYMI_ITEM_HEADER_SUBTITLE_SUMMARY: ' started a conversation \u2014 here\'s a TL;DR:',
  ICYMI_ITEM_HEADER_SUBTITLE_CHANGED_STATUS: ' changed their status',
  ICYMI_PRE_ALPHA: 'PRE-ALPHA',
  ICYMI_FORWARD: 'Forward',
  ICYMI_REPLY: 'Reply',
  ICYMI_REPLY_REACT: 'React or Reply to {activity}',
  ...
  ICYMI_CUSTOM_SCORING_NONE: 'Good As Is',
  IYCMI_NEW_POSTS: 'New Content',
  ICYMI_FORWARD_MESSAGE: 'Forward Message',
  ICYMI_SHARE_CONVO_SUMMARY: 'Share Conversation',
  ...
  ICYMI_SERVER_DISABLE_WARNING: 'Turning this off means no content from this server will be shown.',
